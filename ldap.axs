var metadata = {
    name: "LDAP",
    description: "Modular LDAP administration toolkit for Active Directory management"
};
...
var _cmd_getusers = ax.create_command(
    ...
    "ldap get-users [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
_cmd_getusers.addArgFlagString("-ou", "ou_path", false, "OU path to search (optional)");
_cmd_getusers.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getusers.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_path = ax.script_dir() + "_bin/get-users." + ax.arch(id) + ".o";
...
var _cmd_getcomputers = ax.create_command(
    ...
    "ldap get-computers [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
_cmd_getcomputers.addArgFlagString("-ou", "ou_path", false, "OU path to search (optional)");
_cmd_getcomputers.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getcomputers.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,cstr,int", [ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/get-computers." + ax.arch(id) + ".o";
...
var _cmd_getgroups = ax.create_command(
    ...
    "ldap get-groups [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
_cmd_getgroups.addArgFlagString("-ou", "ou_path", false, "OU path to search (optional)");
_cmd_getgroups.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getgroups.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,cstr,int", [ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/get-groups." + ax.arch(id) + ".o";
...
var _cmd_getusergroups = ax.create_command(
    ...
    "ldap get-usergroups {user} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_getusergroups.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getusergroups.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,int", [user, is_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/get-usergroups." + ax.arch(id) + ".o";
...
var _cmd_getgroupmembers = ax.create_command(
    ...
    "ldap get-groupmembers {group} [-ou {ou_path}] [-dc {dc_address}]"
);
...
_cmd_getgroupmembers.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getgroupmembers.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr", [group, is_dn, ou_path, dc_address]);
    let bof_path = ax.script_dir() + "_bin/get-groupmembers." + ax.arch(id) + ".o";
...
var _cmd_getobject = ax.create_command(
    ...
    "ldap get-object {target} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_getobject.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getobject.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_path = ax.script_dir() + "_bin/get-object." + ax.arch(id) + ".o";
...
var _cmd_getdomaininfo = ax.create_command(
    ...
    "ldap get-domaininfo [-dc {dc_address}] [--ldaps]"
);
_cmd_getdomaininfo.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getdomaininfo.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int", [dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/get-domaininfo." + ax.arch(id) + ".o";
...
var _cmd_getwritable = ax.create_command(
    ...
    "ldap get-writable [-ou {ou_path}] [-dc {dc_address}] [--ldaps] [--detailed]"
);
_cmd_getwritable.addArgFlagString("-ou", "ou_path", false, "OU path to search");
_cmd_getwritable.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getwritable.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,cstr,int,int", [ou_path, dc_address, use_ldaps, detailed]);
    let bof_path = ax.script_dir() + "_bin/get-writable." + ax.arch(id) + ".o";
...
var _cmd_getdelegation = ax.create_command(
    ...
    "ldap get-delegation {target} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_getdelegation.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getdelegation.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,int", [target, is_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/get-delegation." + ax.arch(id) + ".o";
...
var _cmd_getuac = ax.create_command(
    ...
    "ldap get-uac {target} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
_cmd_getuac.addArgString("target", true, "Object name or DN");
_cmd_getuac.addArgFlagString("-ou", "ou_path", false, "OU path to search");
_cmd_getuac.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getuac.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,int", [target, is_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/get-uac." + ax.arch(id) + ".o";
...
var _cmd_getattribute = ax.create_command(
    ...
    "ldap get-attribute {target} {attribute} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
_cmd_getattribute.addArgString("target", true, "Object name or DN");
_cmd_getattribute.addArgString("attribute", true, "Attribute name to retrieve");
_cmd_getattribute.addArgFlagString("-ou", "ou_path", false, "OU path to search");
_cmd_getattribute.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getattribute.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, attribute, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/get-attribute." + ax.arch(id) + ".o";
    ax.execute_alias(id, cmdline, `execute bof ${bof_path} ${bof_params}`, `Querying ${attribute} for ${target}...`);
});
...
var _cmd_getspn = ax.create_command(
    ...
    "ldap get-spn {target} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
_cmd_getspn.addArgString("target", true, "Object name or DN");
_cmd_getspn.addArgFlagString("-ou", "ou_path", false, "OU path to search");
_cmd_getspn.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getspn.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,int", [target, is_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/get-spn." + ax.arch(id) + ".o";
...
var _cmd_getacl = ax.create_command(
    ...
    "ldap get-acl {target} [-ou {ou_path}] [-dc {dc_address}] [--ldaps] [--resolve]"
);
_cmd_getacl.addArgString("target", true, "Object name or DN");
_cmd_getacl.addArgFlagString("-ou", "ou_path", false, "OU path to search");
_cmd_getacl.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getacl.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,int,int", [target, is_dn, ou_path, dc_address, use_ldaps, resolve]);
    let bof_path = ax.script_dir() + "_bin/get-acl." + ax.arch(id) + ".o";
...
var _cmd_getrbcd = ax.create_command(
    ...
    "ldap get-rbcd {target} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
_cmd_getrbcd.addArgString("target", true, "Object name or DN");
_cmd_getrbcd.addArgFlagString("-ou", "ou_path", false, "OU path to search");
_cmd_getrbcd.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_getrbcd.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,int", [target, is_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/get-rbcd." + ax.arch(id) + ".o";
...
var _cmd_adduser = ax.create_command(
    ...
    "ldap add-user {username} {password} [-fn {firstname}] [-ln {lastname}] [-email {email}] [--disabled] [-ou {ou_path}] [-dc {dc_address}]"
);
...
_cmd_adduser.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_adduser.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,cstr,int,cstr,cstr,int",
        [username, is_dn, password, firstname, lastname, email, disabled, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-user." + ax.arch(id) + ".o";
...
var _cmd_addcomputer = ax.create_command(
    ...
    "ldap add-computer {computer} [-p {password}] [-ou {ou_path}] [-dc {dc_address}] [--disabled] [--ldaps]"
);
...
_cmd_addcomputer.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addcomputer.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int,int",
        [computer, is_dn, password, ou_path, dc_address, disabled, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-computer." + ax.arch(id) + ".o";
...
var _cmd_addgroup = ax.create_command(
    ...
    "ldap add-group {groupname} [-desc {description}] [-type {type}] [-scope {scope}] [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addgroup.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addgroup.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,cstr,cstr,int",
        [groupname, is_dn, description, type, scope, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-group." + ax.arch(id) + ".o";
...
var _cmd_addgroupmember = ax.create_command(
    ...
    "ldap add-groupmember {group} {member} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addgroupmember.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addgroupmember.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,int,cstr,cstr,int",
        [group, is_group_dn, member, is_member_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-groupmember." + ax.arch(id) + ".o";
...
var _cmd_addou = ax.create_command(
    ...
    "ldap add-ou {ou_name} [-desc {description}] [-parent {parent_ou}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addou.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addou.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int",
        [ou_name, is_dn, description, parent_ou, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-ou." + ax.arch(id) + ".o";
...
var _cmd_addsidhistory = ax.create_command(
    ...
    "ldap add-sidhistory {target} {sid_source} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addsidhistory.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addsidhistory.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let use_ldaps = parsed_json["--ldaps"] ? 1 : 0;
    let bof_params = ax.bof_pack("cstr,int,cstr,int,cstr,cstr,int",
        [target, is_target_dn, sid_source, is_sid_source_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-sidhistory." + ax.arch(id) + ".o";
...
var _cmd_addspn = ax.create_command(
    ...
    "ldap add-spn {target} {spn} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addspn.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addspn.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, spn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-spn." + ax.arch(id) + ".o";
...
var _cmd_addattribute = ax.create_command(
    ...
    "ldap add-attribute {target} {attribute} {value} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addattribute.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addattribute.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,cstr,int",
        [target, is_dn, attribute, value, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-attribute." + ax.arch(id) + ".o";
...
var _cmd_adduac = ax.create_command(
    ...
    "ldap add-uac {target} {flags} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_adduac.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_adduac.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, flags, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-uac." + ax.arch(id) + ".o";
...
var _cmd_adddelegation = ax.create_command(
    ...
    "ldap add-delegation {target} {spn} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_adddelegation.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_adddelegation.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, spn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-delegation." + ax.arch(id) + ".o";
...
var _cmd_addace = ax.create_command(
    ...
    "ldap add-ace {target} {trustee} {rights} [-type {type}] [-flags {flags}] [-guid {guid}] [-inherit-guid {inherit_guid}] [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addace.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addace.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,int,cstr,cstr,cstr,cstr,cstr,cstr,cstr,int",
        [target, is_target_dn, trustee, is_trustee_dn, rights, ace_type, flags, guid, inherit_guid, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-ace." + ax.arch(id) + ".o";
...
var _cmd_addrbcd = ax.create_command(
    ...
    "ldap add-rbcd {target} {delegate} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addrbcd.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addrbcd.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,int,cstr,cstr,int",
        [target, is_target_dn, delegate, is_delegate_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-rbcd." + ax.arch(id) + ".o";
...
var _cmd_setpassword = ax.create_command(
    ...
    "ldap set-password {target} {password} [-ou {ou_path}] [-dc {dc_address}]"
);
...
_cmd_setpassword.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_setpassword.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,cstr,int", [target, is_dn, password, old_password, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/set-password." + ax.arch(id) + ".o";
...
var _cmd_setspn = ax.create_command(
    ...
    "ldap set-spn {target} {spn} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_setspn.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_setspn.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, spn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/set-spn." + ax.arch(id) + ".o";
...
var _cmd_setdelegation = ax.create_command(
    ...
    "ldap set-delegation {target} {spn} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_setdelegation.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_setdelegation.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, spn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/set-delegation." + ax.arch(id) + ".o";
...
var _cmd_setattribute = ax.create_command(
    ...
    "ldap set-attribute {target} {attribute} {value} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_setattribute.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_setattribute.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,cstr,int",
        [target, is_dn, attribute, value, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/set-attribute." + ax.arch(id) + ".o";
...
var _cmd_setuac = ax.create_command(
    ...
    "ldap set-uac {target} {flags} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_setuac.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_setuac.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, flags, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/set-uac." + ax.arch(id) + ".o";
...
var _cmd_setowner = ax.create_command(
    ...
    "ldap set-owner {target} {owner} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_setowner.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_setowner.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,int,cstr,cstr,int",
        [target, is_target_dn, owner, is_owner_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/set-owner." + ax.arch(id) + ".o";
...
var _cmd_moveobject = ax.create_command(
    ...
    "ldap move-object {object} {destination} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_moveobject.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_moveobject.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [object, is_dn, destination, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/move-object." + ax.arch(id) + ".o";
...
var _cmd_removegroupmember = ax.create_command(
    ...
    "ldap remove-groupmember {group} {member} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removegroupmember.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_removegroupmember.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,int,cstr,cstr,int",
        [group, is_group_dn, member, is_member_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/remove-groupmember." + ax.arch(id) + ".o";
...
var _cmd_removeobject = ax.create_command(
    ...
    "ldap remove-object {object} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removeobject.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_removeobject.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,int", [object, is_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/remove-object." + ax.arch(id) + ".o";
...
var _cmd_removespn = ax.create_command(
    ...
    "ldap remove-spn {target} {spn} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removespn.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_removespn.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, spn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/remove-spn." + ax.arch(id) + ".o";
...
var _cmd_removedelegation = ax.create_command(
    ...
    "ldap remove-delegation {target} {spn} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removedelegation.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_removedelegation.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, spn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/remove-delegation." + ax.arch(id) + ".o";
...
var _cmd_removeattribute = ax.create_command(
    ...
    "ldap remove-attribute {target} {attribute} [-value {value}] [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removeattribute.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_removeattribute.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,cstr,int",
        [target, is_dn, attribute, value, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/remove-attribute." + ax.arch(id) + ".o";
...
var _cmd_removeuac = ax.create_command(
    ...
    "ldap remove-uac {target} {flags} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removeuac.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_removeuac.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, flags, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/remove-uac." + ax.arch(id) + ".o";
...
var _cmd_removeace = ax.create_command(
    ...
    "ldap remove-ace {target} {ace_index} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removeace.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_removeace.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,int,cstr,cstr,int,cstr,cstr,int", 
        [target, is_dn, trustee, is_trustee_dn, rights, ace_type, ace_index, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/remove-ace." + ax.arch(id) + ".o";
...
var _cmd_removerbcd = ax.create_command(
    ...
    "ldap remove-rbcd {target} {delegate} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removerbcd.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_removerbcd.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,int,cstr,cstr,int",
        [target, is_target_dn, delegate, is_delegate_dn, ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/remove-rbcd." + ax.arch(id) + ".o";
...
var _cmd_addgenericall = ax.create_command(
    ...
    "ldap add-genericall {target} {trustee} [-type {type}] [-flags {flags}] [-guid {guid}] [-inherit-guid {inherit_guid}] [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addgenericall.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
var _cmd_addgenericwrite = ax.create_command(
    ...
    "ldap add-genericwrite {target} {trustee} [-type {type}] [-flags {flags}] [-guid {guid}] [-inherit-guid {inherit_guid}] [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addgenericwrite.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
var _cmd_adddcsync = ax.create_command(
    ...
    "ldap add-dcsync {target} {trustee} [-type {type}] [-flags {flags}] [-guid {guid}] [-inherit-guid {inherit_guid}] [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_adddcsync.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
var _cmd_addasreproastable = ax.create_command(
    ...
    "ldap add-asreproastable {target} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addasreproastable.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addasreproastable.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, "DONT_REQ_PREAUTH", ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-uac." + ax.arch(id) + ".o";
...
var _cmd_addunconstrained = ax.create_command(
    ...
    "ldap add-unconstrained {target} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addunconstrained.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
_cmd_addunconstrained.setPreHook(function (id, cmdline, parsed_json, ...parsed_lines){
    ...
    let bof_params = ax.bof_pack("cstr,int,cstr,cstr,cstr,int", [target, is_dn, "TRUSTED_FOR_DELEGATION", ou_path, dc_address, use_ldaps]);
    let bof_path = ax.script_dir() + "_bin/add-uac." + ax.arch(id) + ".o";
...
var _cmd_addconstrained = ax.create_command(
    "add-constrained",
    "Set/replace delegation SPNs",
    "ldap add-constrained {target} {spn} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_addconstrained.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
var _cmd_removedcsync = ax.create_command(
    "remove-dcsync",
    "Remove an ACE from an object's DACL",
    "ldap remove-dcsync {target} {ace_index} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removedcsync.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
var _cmd_removegenericwrite = ax.create_command(
    "remove-genericwrite",
    "Remove an GenericWrite ACE from an object's DACL",
    "ldap remove-genericwrite {target} {ace_index} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removegenericwrite.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
var _cmd_removegenericall= ax.create_command(
    "remove-genericall",
    "Remove an GenericAll ACE from an object's DACL",
    "ldap remove-genericall {target} {ace_index} [-ou {ou_path}] [-dc {dc_address}] [--ldaps]"
);
...
_cmd_removegenericall.addArgFlagString("-dc", "dc_address", false, "Domain Controller address");
...
cmd_ldap.addSubCommands([_cmd_getdomaininfo, _cmd_getcomputers, _cmd_getwritable, _cmd_getobject, _cmd_getgroups, _cmd_getusers]);
